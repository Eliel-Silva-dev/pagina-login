...
const PrivacyPolicies = () => {
  const nameSite = 'Login | Hydrah tec';
  const datePolitic =
    'Esta política é efetiva a partir de 26 de julho 2024 00:00';
  return (
    <main className={style.privacyPolicies}>
      <section className={style.privacy}>
        ...
        <p>
          ...
          possamos coletar no site <Link href={'/'}>{nameSite}</Link>, e outros
          sites que possuímos e operamos.
        </p>
        <p>
          Solicitamos informações pessoais apenas quando realmente precisamos
          delas para lhe fornecer um serviço. O fazemos por meios justos e
        ...
        <p>
          ...
          informação que o {nameSite} oferece no site e com caráter enunciativo,
          mas não limitativo:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            (softwares) do {nameSite}, de seus fornecedores ou terceiros, para
